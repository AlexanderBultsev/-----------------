...
function leafTrace(x, y) {
    ...
    leaf.setAttribute("width", "20px")
    leaf.setAttribute("height", "20px")
    leaf.style.left = (x - 10) + "px"
    leaf.style.top = (y - 10) + "px"
    leaf.style.transform = "scale(1) rotate(" + ((x + y) % 360 - 180) + "deg)"
